@php
  $title = ($item->id ? 'Edit' : 'Tambah') . ' Karyawan';
@endphp
...
@section('right-menu')
  <li class="nav-item">
    ...
    <a class="btn btn-default" href="{{ url('/admin/officer/') }}" onclick="return confirm('Batalkan perubahan?')"><i class="fas fa-cancel mr-1"></i>Batal</a>
  </li>
@endSection
      ...
      <div class="card card-primary">
        <div class="card-body">
          <div class="form-group">
            <label for="name">Nama Karyawan <span class="required">*</span></label>
          ...
          <div class="form-group">
            ...
            <div class="text-muted">Officer tidak aktif akan disembunyikan.</div>
          </div>
        </div>
      </div>
    </div>
