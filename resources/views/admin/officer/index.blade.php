...
@section('right-menu')
  <li class="nav-item">
    <a class="btn plus-btn btn-primary mr-2" href="{{ url('/admin/officer/edit/0') }}" title="Baru"><i
        ...
        <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-6 d-flex justify-content-end">
                <div class="form-group form-inline">
                  ...
                  <input class="form-control" id="search" name="search" type="text" value="{{ $filter['search'] }}" placeholder="Cari officer">
                </div>
              </div>
            </div>
          </form>
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-sm">
              <thead>
                <tr>
                  <th style="width:30%">Nama Officer</th>
                  <th>Keterangan</th>
                  <th>Catatan</th>
                  <th>Status</th>
